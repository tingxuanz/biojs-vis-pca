...
setup_zoom = function(graph){
  ...
  setup_svg = function(graph){
    ...
    var svgForScatter = d3.select(options.target).append("svg")
    ...
    */
    ...
    graph.svgForScatter = svgForScatter;
  ...
  init = function(init_options){
      ...
      svgForScatter = graph.svgForScatter;
